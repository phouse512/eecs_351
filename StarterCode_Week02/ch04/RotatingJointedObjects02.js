...
//==============================================================================
  var vertices = new Float32Array ([
     ...
     0.19, 0.00, 0.00, 1.00,  
     0.0,  0.49, 0.00, 1.00,
     0.19, 0.01, 0.00, 1.00,		// second triangle
     0.19, 0.49, 0.00, 1.00,
     0.01, 0.49, 0.00, 1.00,
  ]);
...
//==============================================================================
  ...
  //-------Draw Upper Arm----------------
  modelMatrix.translate(0, 0.5, 0); 			// Make new drawing axes that
  ...
  modelMatrix.translate(-0.2, 0, 0);			// Make new drawing axes that
  						// move sideways by the width of our rectangle model
  						...
  						// we translate by the 0.2, not 0.2*0.6.
  // DRAW BOX: Use this matrix to transform & draw our VBO's contents:
  gl.uniformMatrix4fv(u_ModelMatrix, false, modelMatrix.elements);
  gl.drawArrays(gl.TRIANGLES, 0, n);
  ...
  // Then draw LOWER jaw of robot pincer..
